...
namespace HistoryManager
{
    public partial class HistoryWindow : Form
    {
        ...
        public void GridViewInitialize()
        {
            ...
            dataGridViewHistory.Columns[1].Width = 100;
            dataGridViewHistory.Columns[2].Width = 100;
            dataGridViewHistory.Columns[3].Width = 160;
            dataGridViewHistory.Columns[4].Width = 150;
        ...
        {
            if (ProjectType == "BLOWER")
            {
                comboBoxResult.Items.Add("All");
                comboBoxResult.Items.Add("OK");
                comboBoxResult.Items.Add("NG");
                comboBoxResult.Items.Add("CODE NG");
                comboBoxResult.Items.Add("MIX NG");
                comboBoxResult.Items.Add("DUMMY");
            }
            else
            {
                comboBoxResult.Items.Add("All");
